...
## Project Structure
    ...
    ├── testapiautoteammemb_68722  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammemb_68722`
...
2. Clone this repo and `cd testapiautoteammemb_68722`
